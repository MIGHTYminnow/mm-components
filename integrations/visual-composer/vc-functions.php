...
function mm_vc_register_demo_template() {
	...
	$data['content']      = <<<CONTENT
		[vc_row][vc_column][vc_text_separator title="Blockquote"][mm_blockquote image_id="56" quote="This is a blockquote. This blockquote should have an image and a citation." citation="Smart Person"][mm_blockquote quote="This is a blockquote. This blockquote should have no image but should have a citation." citation="Smart Person"][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Button"][mm_button link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F|title:Sample%20Page|" size="large" alignment="center"]This is the button text[/mm_button][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Countdown"][mm_countdown date="2015-12-25" time="18:00:00" timezone="GMT-0800"][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Custom Heading"][mm_custom_heading font_size="36px" text_transform="uppercase" text_align="center"]This is a custom heading[/mm_custom_heading][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Expandable Content"][mm_expandable_content link_style="button" link_text="Click to Expand" link_alignment="center"][mm_polaroid title="Just a Polaroid here" image="57" link_text="Link Text" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F||"]This is the text for the polaroid.[/mm_polaroid][/mm_expandable_content][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Hero Banner"][mm_hero_banner overlay_color="#000" overlay_opacity="0.2" text_position="text-center" background_image="59" background_position="cover" heading="Hero Banner Heading" button_text="Button Text" secondary_cta="VGhpcyUyMGlzJTIwYSUyMHNlY29uZGFyeSUyMGNhbGwlMjB0byUyMGFjdGlvbiUyMG9uJTIwdGhlJTIwSGVybyUyMEJhbm5lci4="]This is a hero banner. It should have a black overlay with an opacity of 0.2, and the background image should always cover the whole banner area.[/mm_hero_banner][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Highlight Box"][mm_highlight_box heading_text="Highlight Box Heading" paragraph_text="Highlight box paragraph text. Highlight box paragraph text." link_text="Link Text" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F||"][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Icon Box"][mm_icon_box icon_fontawesome="fa fa-bicycle" heading_text="Icon Box Heading" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F|title:Link%20Text|" link_text="Link Text"]Icon box text. Icon box text. Icon box text. Icon box text. Icon box text. Icon box text.

Icon box text. Icon box text. Icon box text. Icon box text.[/mm_icon_box][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Image Grid"][mm_image_grid style="style-full-image" max_in_row="2" title="Image Grid Title" el_class="extra-class"][mm_image_grid_image title="Image Grid Image #1" subtitle="Just a subtitle" image="57" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F||"][mm_image_grid_image title="Image Grid Image #2" subtitle="Just another subtitle" image="57" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F||"][/mm_image_grid][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Logo Strip"][mm_logo_strip title="Just some logos here" title_alignment="center" images="52,53,54" image_size="thumbnail"][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Polaroid"][mm_polaroid title="Polaroid" image="57" link_text="Link Text" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F||"]Just some text content for the polaroid.[/mm_polaroid][/vc_column][/vc_row][vc_row][vc_column][vc_text_separator title="Polaroid 2"][mm_polaroid_2 title="Polaroid 2" image="57" caption="Just a polaroid caption here" caption_color="dark-text" link="url:http%3A%2F%2Flocal.wordpress.dev%2Fsample-page%2F||"][/vc_column][/vc_row][vc_row][vc_column][mm_posts post_type="post" show_featured_image="1" show_post_info="1" show_post_meta="1"][/vc_column][/vc_row]
CONTENT;
