...
function mm_vc_image_grid() {
	...
	vc_map( array(
		'name' => __( 'Image Grid', 'mm-visual-composer-add-ons' ),
		'base' => 'image_grid',
		...
		// add params same as with any other content element
			...
			array(
				'type' => 'textfield',
				'heading' => __( 'Extra class name', 'mm-visual-composer-add-ons' ),
				'param_name' => 'el_class',
				'description' => __('If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'mm-visual-composer-add-ons'),
			),
			array(
				'type' => 'dropdown',
				'heading' => __( 'Style', 'mm-visual-composer-add-ons' ),
				'param_name' => 'style',
				'value' => array(
					__( 'Full Image', 'mm-visual-composer-add-ons ') => 'style-full-image',
					__( 'Thumbnail/Text Card', 'mm-visual-composer-add-ons ') => 'style-thumbnail-text-card',
				),
			),
		),
	...
	vc_map( array(
		'name' => __( 'Image Grid Image', 'mm-visual-composer-add-ons' ),
		...
		'params' => array(
			array(
				'type' => 'textfield',
				'heading' => __( 'Caption/Title', 'mm-visual-composer-add-ons' ),
				'admin_label' => true,
				'param_name' => 'title',
			),
			array(
				'type' => 'textfield',
				'heading' => __( 'Subtitle', 'mm-visual-composer-add-ons' ),
				'param_name' => 'subtitle',
			),
			array(
				'type' => 'attach_image',
				'heading' => __( 'Image', 'mm-visual-composer-add-ons' ),
				'param_name' => 'image',
				'mm_image_size_for_desc' => 'Image Grid',
			),
			array(
				'type' => 'vc_link',
				'heading' => __( 'Link', 'mm-visual-composer-add-ons' ),
				'param_name' => 'link',
			),
			array(
				'type' => '',
				'heading' => __( 'Style', 'mm-visual-composer-add-ons' ),
				'param_name' => 'style',
				'description' => __( 'You cannot set styles for individual Image Grid Images. Instead, set the style for the parent Image Grid container (the Visual Composer component that contains this image).', 'mm-visual-composer-add-ons' ),
			),
		)
	) );
